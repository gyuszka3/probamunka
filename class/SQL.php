...
class SQL extends Database
{
    ...
    public function count_entyityId($entityType)
    {
    ...
    public function get_entityId($entity_id)
    {
    ...
    public function update_check($update_id)
    {
        $result=$this->db->probamunka->find(["_id" => new MongoDB\BSON\ObjectId($update_id)]);

        return $result->toArray();
    }
    public function add_update($result, $target_url)
    {
        $date=new MongoDB\BSON\UTCDateTime();
        $array=[
    ...
    public function resolve_find($full_url, $http_code, $sorting)
    {
